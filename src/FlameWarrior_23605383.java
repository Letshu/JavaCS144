public class FlameWarrior_23605383 extends Warrior_23605383 implements WarriorTypeInterface_23605383 {
    ...
    public FlameWarrior_23605383(int ID,int Age,double health,double offensePower,double defenseStrength,int weaponInventory,int Xvalue,int Yvalue,String moves,String name) {
