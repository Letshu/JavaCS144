public class WaterWarrior_23605383 extends Warrior_23605383 implements WarriorTypeInterface_23605383 {
    ...
    public WaterWarrior_23605383(int ID,int Age,double health,double offensePower,double defenseStrength,int weaponInventory,int Xvalue,int Yvalue,String moves,String name) {
